...
- Python
- Textual for the TUI
- LangChain for model/tool wrappers and embeddings
- LangGraph for the agent loop, subagent routing, and state
...
No class garden. Mostly plain functions, a few small dataclasses.
