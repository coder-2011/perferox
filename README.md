...
Authenticate the local LLM through the CLI before opening the TUI. Perferox supports ChatGPT subscription and GitHub Copilot OAuth through LiteLLM; the TUI never opens a login flow.
