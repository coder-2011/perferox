...
CREATE TABLE IF NOT EXISTS anomalies (
  anomaly_id INTEGER PRIMARY KEY, agent_id INTEGER NOT NULL, run_id INTEGER NOT NULL,
  date TEXT NOT NULL, summary TEXT NOT NULL,
  FOREIGN KEY(agent_id, run_id) REFERENCES runs(agent_id, run_id)
);

CREATE TABLE IF NOT EXISTS explorer_state_lines (
  line_id INTEGER PRIMARY KEY, agent_id INTEGER,
  created_at TEXT NOT NULL, line TEXT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS cloud_resources (
  agent_id INTEGER NOT NULL, provider TEXT NOT NULL, resource_id TEXT NOT NULL,
  environment TEXT NOT NULL,
  created_at TEXT NOT NULL, terminated_at TEXT, cleanup_error TEXT NOT NULL DEFAULT '',
...
CREATE INDEX IF NOT EXISTS idx_cloud_resources_active ON cloud_resources(agent_id, terminated_at);
